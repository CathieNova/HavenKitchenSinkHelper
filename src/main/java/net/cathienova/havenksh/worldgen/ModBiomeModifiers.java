...
public class ModBiomeModifiers {
    ...
    public static void bootstrap(BootstapContext<BiomeModifier> context) {
        ...
        context.register(add_scorched_stone, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.scorched_stone_placed_key)),
                GenerationStep.Decoration.UNDERGROUND_ORES));

        context.register(add_scorched_copper_ore, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.scorched_copper_ore_placed_key)),
                GenerationStep.Decoration.UNDERGROUND_ORES));

        context.register(add_scorched_coal_ore, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
        ...
        context.register(add_scorched_gold_ore, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.scorched_gold_ore_placed_key)),
                GenerationStep.Decoration.UNDERGROUND_ORES));

        context.register(add_scorched_redstone_ore, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.scorched_redstone_ore_placed_key)),
                GenerationStep.Decoration.UNDERGROUND_ORES));

        context.register(add_scorched_lapis_ore, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.scorched_lapis_ore_placed_key)),
                GenerationStep.Decoration.UNDERGROUND_ORES));

        context.register(add_scorched_quartz_ore, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.scorched_quartz_ore_placed_key)),
                GenerationStep.Decoration.UNDERGROUND_ORES));

        context.register(add_scorched_diamond_ore, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.scorched_diamond_ore_placed_key)),
                GenerationStep.Decoration.UNDERGROUND_ORES));

        context.register(add_scorched_emerald_ore, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
    ...
    private static ResourceKey<BiomeModifier> registerKey(String name) {
        return ResourceKey.create(ForgeRegistries.Keys.BIOME_MODIFIERS, new ResourceLocation(HavenKSH.MOD_ID, name));
    }
}
