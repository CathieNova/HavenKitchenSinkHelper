...
public class ModToolTiers
{
    public static final Tier stone = TierSortingRegistry.registerTier(
            new ForgeTier(2, 131, 2f, 1f, 25,
                          BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.of(Tags.Items.STONE)),
            new ResourceLocation(HavenKSH.MOD_ID, "stone"),
            List.of(Tiers.WOOD),
            List.of(Tiers.IRON));
    ...
    public static final Tier copper = TierSortingRegistry.registerTier(
            ...
            new ResourceLocation(HavenKSH.MOD_ID, "copper"),
            List.of(Tiers.STONE),
            List.of(Tiers.IRON));

    public static final Tier iron = TierSortingRegistry.registerTier(
            new ForgeTier(2, 250, 3f, 2f, 25,
                          BlockTags.NEEDS_IRON_TOOL, () -> Ingredient.of(Tags.Items.INGOTS_IRON)),
            new ResourceLocation(HavenKSH.MOD_ID, "iron"),
            List.of(Tiers.STONE, copper),
            List.of(Tiers.DIAMOND));

    public static final Tier gold = TierSortingRegistry.registerTier(
            new ForgeTier(0, 169, 4f, 3f, 25,
                          BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.of(Tags.Items.INGOTS_GOLD)),
            new ResourceLocation(HavenKSH.MOD_ID, "gold"),
            List.of(),
            List.of(Tiers.WOOD, Tiers.STONE));

    public static final Tier diamond = TierSortingRegistry.registerTier(
            new ForgeTier(3, 1561, 5f, 4f, 25,
                          BlockTags.NEEDS_DIAMOND_TOOL, () -> Ingredient.of(Tags.Items.GEMS_DIAMOND)),
            new ResourceLocation(HavenKSH.MOD_ID, "diamond"),
            List.of(Tiers.IRON, copper),
    ...
    public static final Tier emerald = TierSortingRegistry.registerTier(
            ...
            new ResourceLocation(HavenKSH.MOD_ID, "emerald"),
            List.of(Tiers.IRON, copper),
            List.of(Tiers.NETHERITE));
    ...
    public static final Tier netherite = TierSortingRegistry.registerTier(
            ...
            new ResourceLocation(HavenKSH.MOD_ID, "netherite"),
            List.of(Tiers.DIAMOND),
            List.of());
    ...
    public static final Tier havenite = TierSortingRegistry.registerTier(
            ...
            new ResourceLocation(HavenKSH.MOD_ID, "havenite"),
            List.of(Tiers.NETHERITE),
            List.of());
}
