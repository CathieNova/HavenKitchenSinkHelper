    ...
    public static class ModAdvancements implements AdvancementGenerator {
        ...
        public void generate(HolderLookup.Provider provider, Consumer<AdvancementHolder> consumer, ExistingFileHelper existingFileHelper) {
            ...
            AdvancementHolder woodenCobbleGen = Advancement.Builder.advancement()
                    ...
                    .save(consumer, ResourceLocation.fromNamespaceAndPath(HavenKSH.MOD_ID, "wooden_cobble_gen").toString());
            ...
            AdvancementHolder woodenCobbleGen2 = Advancement.Builder.advancement()
                    ...
                    .save(consumer, ResourceLocation.fromNamespaceAndPath(HavenKSH.MOD_ID, "stone_cobble_gen").toString());
            ...
            AdvancementHolder woodenCobbleGen3 = Advancement.Builder.advancement()
                    ...
                    .save(consumer, ResourceLocation.fromNamespaceAndPath(HavenKSH.MOD_ID, "iron_cobble_gen").toString());
            ...
            AdvancementHolder woodenCobbleGen4 = Advancement.Builder.advancement()
                    ...
                    .save(consumer, ResourceLocation.fromNamespaceAndPath(HavenKSH.MOD_ID, "gold_cobble_gen").toString());
            ...
            AdvancementHolder woodenCobbleGen5 = Advancement.Builder.advancement()
                    ...
                    .save(consumer, ResourceLocation.fromNamespaceAndPath(HavenKSH.MOD_ID, "diamond_cobble_gen").toString());
            ...
            AdvancementHolder woodenCobbleGen6 = Advancement.Builder.advancement()
                    ...
                    .save(consumer, ResourceLocation.fromNamespaceAndPath(HavenKSH.MOD_ID, "emerald_cobble_gen").toString());
            ...
            AdvancementHolder woodenCobbleGen7 = Advancement.Builder.advancement()
                    ...
                    .save(consumer, ResourceLocation.fromNamespaceAndPath(HavenKSH.MOD_ID, "netherite_cobble_gen").toString());
            ...
            AdvancementHolder woodenCobbleGen8 = Advancement.Builder.advancement()
                    ...
                    .save(consumer, ResourceLocation.fromNamespaceAndPath(HavenKSH.MOD_ID, "creative_cobble_gen").toString());
