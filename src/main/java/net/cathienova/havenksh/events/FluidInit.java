...
public class FluidInit
{
    ...
    public static final FluidRegistryContainer acid_fluid = new FluidRegistryContainer("acid_fluid", FluidType.Properties.create()
            ...
            .canExtinguish(true),
            () -> FluidRegistryContainer.createExtension(new FluidRegistryContainer.ClientExtensions(HavenKSH.MOD_ID, "acid_fluid")
            .tint(0x1A21961a)
    ...
    /*public static final FluidRegistryContainer havenite_fluid = new FluidRegistryContainer("havenite_fluid", FluidType.Properties.create()
            ...
            .supportsBoating(true)
            .canExtinguish(true),
            () -> FluidRegistryContainer.createExtension(new FluidRegistryContainer.ClientExtensions(HavenKSH.MOD_ID, "havenite_fluid")
            .tint(0x1Aff007f)
